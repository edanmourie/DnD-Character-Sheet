...
function App() {
  return (
    // TODO: Make web page refresh every time you go into a character, because the stats linger from the last character you were on. They only change to the correct character's stats when you refresh.
    <>
      <div className="app">
